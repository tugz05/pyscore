    ...
    $('#addSectionForm').submit(function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                table.ajax.reload();
                alert(response.success || "Section saved successfully!");
            },
            error: function(xhr) {
    ...
    $(document).on('click', '.delete-btn', function() {
        ...
        if (confirm('Are you sure you want to delete this section?')) {
            $.ajax({
                url: `sections/${id}`,
                type: "DELETE",
                data: { _token: $('meta[name="csrf-token"]').attr('content') }, // Include CSRF token
                success: function(response) {
                    table.ajax.reload();
                    alert(response.success || "Section deleted successfully!");
                },
                error: function(xhr) {
