    ...
    <div class="container-fluid bg-gray-100 mx-2">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">
                <i class="fa-brands fa-python text-primary"></i> Archive Classes
            </h1>
                                            ...
                                            <div class="mt-auto d-flex justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenu${classlist.id}">
                                                         <li>
                                                            <a class="dropdown-item restore-btn" data-id="" href="">
                                                                Restore
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item delete-btn text-danger" data-id="" href="">
                                                                Delete
                                                            </a>
                                                        </li>
                                                    </ul>
