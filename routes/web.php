    ...
    Route::middleware(['account_type:student', 'auth'])->prefix('student')->group(function(){
        ...
        Route::post('/request-upgrade', [SettingsController::class, 'requestUpgrade'])->name('user.request.upgrade');
    ...
    Route::middleware(['account_type:admin', 'auth'])->prefix('admin')->group(function(){
        ...
        Route::post('/admin/students/deny-request', [StudentController::class, 'denyUpgradeRequest'])->name('admin.student.deny');
